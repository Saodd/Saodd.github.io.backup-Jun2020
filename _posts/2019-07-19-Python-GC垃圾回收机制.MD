...
> 之前一直认为像Python这样的“高级脚本语言”没必要考虑内存回收机制。
> 不过最近受到启发，在某些情况下利用（或禁用）这个特性，对性能会有不错的提升，所以也必须要了解一下。
...
![循环引用1](/screenshot/2019-07-19-Circular-Ref-1.webp)

然后互相引用：

![循环引用2](/screenshot/2019-07-19-Circular-Ref-2.webp)
