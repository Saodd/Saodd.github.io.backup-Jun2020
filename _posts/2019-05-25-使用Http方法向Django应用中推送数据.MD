...
![展示3:Mongo-express列表页](/screenshot/20190525_Mongo_List.png)  
但是问题也是有的，日志全部挤在一行了：  
![展示4:Mongo-express详情页](/screenshot/20190525_Mongo_Detail.png)  
...
![展示1:Admin列表页](/screenshot/20190525_Admin1.png)  
我可以在详情页中查看详细的日志数据：  
![展示1:Admin详情页](/screenshot/20190525_Admin2.png)
